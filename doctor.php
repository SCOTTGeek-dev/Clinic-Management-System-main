...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Docteur mis à jour avec succés ! </p>
                <p>
...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Enregistrement de Docteur inséré avec succés ! </p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = 'view-doctor.php';\",1500);</script>"; ?>
                </p>
...
<li class="breadcrumb-item"><a href="add_user.php">Docteur</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Nom du docteur</label>
        <div class="col-sm-4">
...
<?php } ?>
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Charge de consultation horaire</label>
        <div class="col-sm-4">
