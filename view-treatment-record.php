...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Traitement supprimé avec succés !</p>
            <p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Es-tu sur de vouloir supprimer cet enregistrement ?</p>
    <p>
...
<li class="breadcrumb-item"><a>Voir les traitements</a>
</li>
<li class="breadcrumb-item"><a href="#">Voir les traitements/a>
</li>
</ul>
</div>
</div>
...
<thead>
<tr>
    <th width="71"  scope="col">Type de traitement</th>
    <th width="52"  scope="col">Patient</th>
    <th width="78"  scope="col">Docteur</th>
    <th width="82"  scope="col">Description du traitement</th>
    <th width="43"  scope="col">Date de traitement</th>
    <th width="43"  scope="col">Temps de traitement</th>
</tr>
</thead>
<tbody>
  <?php
