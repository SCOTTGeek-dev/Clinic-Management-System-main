...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Patient supprimé avec succés !</p>
            <p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Es-tu sur de supprimer les enregistrements ?</p>
    <p>
      <a href="view-patient.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view-patient.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
...
<tr>
    ...
    <th>Détails d'admission</th>
    <th>Adresse</th>
    <th>Profil du aptient</th>
    <th>Action</th>
</tr>
</thead>
<tbody>
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
    ...
    echo "<tr>
        ...
        if(isset($_SESSION['adminid']))
        {
          ...
          <a href='patientreport.php?patientid=$rs[patientid]' class='btn btn-success'>Voir le rapport</a>";
        }
        echo "</td></tr>";
      }
?>
