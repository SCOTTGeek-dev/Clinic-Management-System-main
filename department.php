...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Département mis à jour vaec succés ! </p>
                <p>
...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Département inséré avec succés ! </p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
...
<li class="breadcrumb-item"><a>Département</a>
</li>
<li class="breadcrumb-item"><a href="#">Ajouter Département</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Nom de département</label>
        <div class="col-sm-8">
