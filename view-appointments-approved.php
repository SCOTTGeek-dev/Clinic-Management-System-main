...
?>
    <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Pointage effectué avec succés !</p>
        <p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Est ce que t'es sur de supprimer cet enregistrement ?</p>
    <p>
...
<li class="breadcrumb-item"><a>Pointage approuvé ! </a>
</li>
<li class="breadcrumb-item"><a href="view-appointments-approved.php">Pointage approuvé</a>
</li>
</ul>
</div>
</div>
...
<?php
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          echo "<tr>
          <td>&nbsp;" . (isset($rspat['patientname']) ? $rspat['patientname'] : '') . "<br>&nbsp;" . (isset($rspat['mobileno']) ? $rspat['mobileno'] : '') . "</td>
          <td>&nbsp;" . (isset($rs['appointmentdate']) ? date("d-M-Y", strtotime($rs['appointmentdate'])) : '') . " &nbsp; " . (isset($rs['appointmenttime']) ? date("H:i A", strtotime($rs['appointmenttime'])) : '') . "</td>
          <td>&nbsp;" . (isset($rsdept['departmentname']) ? $rsdept['departmentname'] : '') . "</td>
          <td>&nbsp;" . (isset($rsdoc['doctorname']) ? $rsdoc['doctorname'] : '') . "</td>
          <td>&nbsp;" . (isset($rs['app_reason']) ? $rs['app_reason'] : '') . "</td>
          <td>&nbsp;" . (isset($rs['status']) ? $rs['status'] : '') . "</td>
          <td>";
