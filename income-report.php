...
?>
    <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Heure de visite supprimée avec succés.</p>
        <p>
...
<li class="breadcrumb-item"><a>Rapport de revenu</a>
</li>
<li class="breadcrumb-item"><a href="#">Rapport de revenu</a>
</li>
</ul>
</div>
</div>
...
<tr>
    ...
    <th width="86" scope="col">Montant de rémunération</th>
</tr>
</thead>
<tbody>
        <?php
  ...
  //Treatment Cost
          ...
          echo " </td><td>DH. $rs[bill_amount]</td></tr>";
