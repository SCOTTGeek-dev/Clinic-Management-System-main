...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Pointage approuvé avec succés !</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
             <?php echo "<script>setTimeout(\"location.href = 'view-prescription.php';\",1500);</script>"; ?>
            </p>
...
<li class="breadcrumb-item"><a>Voir les préscriptions</a>
</li>
<li class="breadcrumb-item"><a href="#">Voir les préscriptions</a>
</li>
</ul>
</div>
</div>
...
<div class="page-body">
      ...
      <tr>
                ...
                <td><strong>Nom du médicament</strong></td>
      ...
      <div class="advice">
        ...
        <div class="sign" style="float:right; margin-top:100px; margin-right:100px;">
          ...
          <p align="center">Signature approuvée</p>
        </div>
      ...
      <div class="ftr" style="width:100%; background:#2B66B1; padding:7px;">
        <h4 style="color:#ffffff;" align="center"><strong>HealthCare</strong></h4>
      </div>
      </div>
