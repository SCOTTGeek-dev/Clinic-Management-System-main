...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Patient mis à jour avec succés !</p>
                <p>
...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Patient inséré avec succés ! </p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = 'view-patient.php';\",1500);</script>"; ?>
                </p>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Nom de patient</label>
        <div class="col-sm-4">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Date admission</label>
        <div class="col-sm-4">
        ...
        <label class="col-sm-2 col-form-label">Temps admission</label>
        <div class="col-sm-4">
    ...
    <div class="form-group row">
        ...
        <label class="col-sm-2 col-form-label">Groupe sanguin</label>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <select name="gender" id="gender" class="form-control" required="">
                ...
                <option value="Male" <?php if(isset($_GET['editid']))
                    { if($rsedit['gender'] == 'Male') { echo 'selected'; } } ?>>Masculin</option>
                <option value="Female" <?php if(isset($_GET['editid']))
                    { if($rsedit['gender'] == 'Female') { echo 'selected'; } } ?>>Féminin</option>
            </select>
        </div>
