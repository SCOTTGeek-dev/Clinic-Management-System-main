...
?>
     <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Pointage supprimé avec succés !</p>
        <p>
...
?>
      ...
      <div class="table-responsive dt-responsive">
        <table id="dom-jqry" class="table table-striped table-bordered nowrap">
          <tbody>
            <tr>
              <th scope="col"><div align="right">Montant à payer &nbsp; </div></th>
              <td>&nbsp;&#x20B9;. <?php echo $billamt; ?></td>
            </tr>
            <tr>
        ...
        <div class="sign" style="float:right; margin-top:100px; margin-right:100px;">
          ...
          <p align="center">Signature agréée</p>
        </div>
...
<!-- ----------------------------------------------------------------------------- -->
    ...
    <div class="ftr" style="width:100%; background:#2B66B1; padding:7px;">
      <h4 style="color:#ffffff;" align="center"><strong>Système de gestion multi-hopitaux HealthCare</strong></h4>
    </div>
    ...
    ?>
                    <div class="table-responsive dt-responsive">
                      ...
                      <tr>
                            ...
                            <td></td>
                            <th scope="col"><div align="right">Montant paiement &nbsp; </div></th>
                            <td><?php
                      $sql ="SELECT * FROM billing_records where billingid='$rsbilling_records[billingid]'";
                      $qsql = mysqli_query($conn,$sql);
                      $billamt= 0;
                  ...
                  ?>
                    &nbsp;&#x20B9;. <?php echo $billamt; ?></td>
                      ...
                      <tr>
                        <th scope="col"><div align="right">Montant du budget</div></th>
                    ...
                    <?php } ?><br><br>
                     <a class="btn btn-primary" href="paymentdischarge.php?appointmentid=<?php echo $rsappointment[0]; ?>&patientid=<?php echo $_GET['patientid']; ?>">Payer</a>
                    </div>
                  </p>
              </div>
          </div>
