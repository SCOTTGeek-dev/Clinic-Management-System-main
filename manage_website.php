                ...
                <div class="row">
                                ...
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                     ...
                                     <!--   <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Code de devise</label>
                                                <div class="col-sm-9">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Symbole de devise</label>
                                                <div class="col-sm-9">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Logo de la plateforme</label>
                                                <div class="col-sm-9">
                  ...
                  <input type="hidden" value="<?=$website_logo?>" name="old_website_image">
                          ...
                          <input type="file" class="form-control" name="invoice_image">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Logo de la page de connexion</label>
                                                <div class="col-sm-9">
                          ...
                          <input type="file" class="form-control" name="back_login_image">
                                        ...
                                        <button type="submit" name="btn_web" class="btn btn-primary btn-flat m-b-30 m-t-30">Mettre a jour</button>
                                    </form>
                                </div>
                            </div>
                        </div>
