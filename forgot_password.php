...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>E-mail envoyé avec succés. Vérifier votre E-mail et réessayez</p>
    <p>
...
<div class="col-md-12">
<h3 class="text-left">Récupérer votre mot de passe</h3>
</div>
</div>
...
<div class="row">
<div class="col-md-12">
<button type="submit" name="btn_forgot" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Rétablir mot de passe</button>
</div>
 </div>
<p class="f-w-600 text-right">Précédent <a href="login.php">Login.</a></p>
<div class="row">
<div class="col-md-10">
<p class="text-inverse text-left m-b-0">Merci.</p>
<p class="text-inverse text-left"><a href="index.php"><b class="f-w-600">Revenir au site</b></a></p>
</div>
<div class="col-md-2">
