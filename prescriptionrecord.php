...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Prescription mise à jour avec succés !</p>
            <p>
...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Préscription insérée avec succés !</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Est ce que vous etes sur de supprimer cet enregistrement ?</p>
    <p>
...
<li class="breadcrumb-item"><a>Préscription</a>
</li>
<li class="breadcrumb-item"><a href="#">Enregistrement de Préscription</a>
</li>
</ul>
</div>
</div>
      ...
      ?>
        ...
        <tr>
          ...
          <td><select class="form-control show-tick" name="instruction" id="instruction" value="<?php echo $rsedit['instruction']; ?>">
            <option value="">Sélectionner</option>
            <option value="Before Food">Avant repas</option>
            <option value="After Food">Aprés repas/option>
            <option value="When required">Si requis</option>
          </select>
        </td>
        </tr>
        <tr>
          <td colspan="2" align="center"><button id="submit" type="submit" name="submit" class="btn btn-primary m-b-0">Enregistrer</button></td>
        </tr>
      </tbody>
    </table>
  </div>
...
<div class="ftr" style="width:100%; background:#2B66B1; padding:7px;">
  <h4 style="color:#ffffff;" align="center"><strong>Projet de fin d'année HealthCare</strong></h4>
</div>
</div>
