...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Est ce que t'es sur de vouloir supprimer cet enregistrement ?</p>
    <p>
      <a href="del_roles.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view_roles.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
...
<li class="breadcrumb-item"><a>Gérer les roles</a>
</li>
...
<div class="card-header">
    <div class="col-sm-10">
        <a href="assign_roles.php"><button class="btn btn-primary pull-right">+ Ajouter role</button></a>
    </div>
