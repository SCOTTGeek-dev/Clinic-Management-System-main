...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 03 juil. 2024 à 20:38
...
(1, 'admin', 'youness@gmail.com', 'aa7f019c326413d5b8bcad4314228bcd33ef557f5d81c7cc977f7728156f4357', 'Youness Hamdaoui', 'admin', 'Male', '2018-11-26', '2126567850', '<p>Maharashtra, India</p>\r\n', '<p>admin panel</p>\r\n', 'profile.jpg', '2018-04-30', '2019-10-15', 1, '0000-00-00', 0);
...
(11, '', 1, 0, 1, '2024-07-02', '12:12:00', 1, 'Approved', 'TEST', 0),
(12, '', 4, 0, 1, '2024-07-03', '12:12:00', 1, 'Approved', 'Je suis malade hahahaha', 0);
...
--
-- Structure de la table `billing_records`
--
...
--
-- Déchargement des données de la table `billing_records`
--
...
(1, 'Dr. Hajjaj', '9389178879', 2, 'malak@gmail.com', '0bd27e16a12449c7266ef0babd1325bf32a719cdf42a3dccd1fd9d494410b7bb', 'Active', 'MD', 5.0, 300.00, 0),
(3, 'ahmed', '9087654467', 2, 'ahmed', '2539cc765eb241527b47d39b79fdc72c4578449ffdd6ce498993b35b98998676', 'Active', 'FACULTE DE MEDECINE RABAT', 12.0, 200.00, 0);
...
(1, 1, '09:00:00', '11:00:00', '', 'Active', 0);

-- --------------------------------------------------------

--
-- Structure de la table `lifestyle`
--
...
--
-- Déchargement des données de la table `lifestyle`
--
...
(8, 13, 'tests dial lmrara', '0000-00-00', 'Prescription to be followed and to be reported on next review date.');
...
(1, 'Hopital', 'rabat@polyclinic.com', 'www.polyclinic.com', '#', 'Rabat,Morocco', 'DH', 'right', '1', '0000-00-00', '5.0', 'HEALTH(1)(1)(1).png');
...
(4, 'Sohail', '2020-12-10', '12:44:00', '#123, Mysore', '8247028009', 'Mysore', '570001', 'sohail@gmail.com', '05669b6aa68797258ae6bbaeb0c3c004499ff5ec6b17dfd202c6ccfd9e145e78', 'B+', 'Male', '2000-03-17', 'Active', 1),
...
(6, 'Patient', '2024-07-02', '12:12:00', 'adresse', '066666666', 'ISTANBUL', '', 'patient', 'ce0d4a4b70196ec47866742b8b9ce06235f8ba845901cc6f68894225cd6e018e', 'A-', 'Male', '2024-07-01', 'Active', 0);
...
(13, 1, 4, 'Delivered through appointment', 12, '2024-07-01', 'Active', 12),
(14, 1, 5, 'Delivered through appointment', 10, '2024-07-01', 'Active', 10);
...
(26, 13, 'Cofsils (Syrup)', 30, '0-0-1', 'Before Food', 'Active');
...
--
-- Structure de la table `tbl_email_config`
--
...
--
-- Déchargement des données de la table `tbl_permission`
--
...
--
-- Structure de la table `tbl_permission_role`
--
...
--
-- Déchargement des données de la table `tbl_permission_role`
--
...
--
-- Index pour la table `billing_records`
--
...
--
-- Index pour la table `tbl_email_config`
--
ALTER TABLE `tbl_email_config`
  ADD PRIMARY KEY (`e_id`);

--
-- Index pour la table `tbl_permission`
--
ALTER TABLE `tbl_permission`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl_permission_role`
--
ALTER TABLE `tbl_permission_role`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl_role`
--
...
--
-- AUTO_INCREMENT pour la table `billing_records`
--
ALTER TABLE `billing_records`
...
--
-- AUTO_INCREMENT pour la table `lifestyle`
--
ALTER TABLE `lifestyle`
  MODIFY `lifestyle_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `prescription_records`
  MODIFY `prescription_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
-- AUTO_INCREMENT pour la table `tbl_email_config`
--
ALTER TABLE `tbl_email_config`
  MODIFY `e_id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `tbl_permission`
--
ALTER TABLE `tbl_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT pour la table `tbl_permission_role`
--
ALTER TABLE `tbl_permission_role`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;

--
-- AUTO_INCREMENT pour la table `tbl_role`
--
ALTER TABLE `tbl_role`
