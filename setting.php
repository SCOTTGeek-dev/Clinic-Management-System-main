...
<li class="breadcrumb-item"><a href="setting.php">Paramètres</a>
</li>
</ul>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="general" role="tab">Général</a>
</li>
</ul>
...
<label class="col-sm-2 col-form-label">Nom de la compagnie</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="business_name" id="business_name" value="<?php echo $business_name;?>" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Email de la compagnie</label>
<div class="col-sm-4">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Site web de la compagnie</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="business_web" id="business_web" value="<?php echo $business_web;?>" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Adresse postale de la compagnie</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-form-label">Adresse de la compagnie</label>
<div class="col-sm-10">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Symbole de devise</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="curr_sym" id="curr_sym" value="<?php echo $curr_sym;?>" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Position de devise</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-form-label">Format Date </label>
<div class="col-sm-4">
...
<div class="form-group row">Taxe par défaut</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="def_tax" id="def_tax" value="<?php echo $def_tax;?>" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Logo par défaut</label>
<div class="col-sm-4">
...
<div class="col-sm-10">
<button type="submit" name="btn_web" class="btn btn-primary m-b-0">Enregistrer</button>
</div>
</div>
</form>
</div>
