...
<li class="breadcrumb-item"><a href="changepassword.php">Changer le mot de passe</a>
</li>
</ul>
</div>
</div>
...
<div class="col-sm-10">
<button type="submit" name="btn_password" class="btn btn-primary m-b-0">Enregistrer</button>
</div>
</div>
</form>
</div>
