...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Etes vous sur de supprimer cet enregistrement ?</p>
    <p>
      <a href="view-pending-appointment.php?delid=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view-pending-appointment.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
...
<li class="breadcrumb-item"><a>Paiement</a>
</li>
<li class="breadcrumb-item"><a href="#">Paiement</a>
</li>
</ul>
</div>
</div>
    ...
    ?>
      <div class="table-responsive dt-responsive">
        <table id="dom-jqry" class="table table-striped table-bordered nowrap">
          <tbody>
            <tr>
              <th scope="col"><div align="right">Numéro de paiement &nbsp; </div></th>
              <td><?php echo $rsbilling_records['billingid']; ?></td>
              <td>Numéro de pointage &nbsp;</td>
              <td><?php echo $rsbilling_records['appointmentid']; ?></td>
            </tr>
            <tr>
              <th width="442" scope="col"><div align="right">Date de paiement &nbsp; </div></th>
              <td width="413"><?php echo $rsbilling_records['billingdate']; ?></td>
              <td width="413">Temps de paiement&nbsp; </td>
        ...
        <tr>
              ...
              <td></td>
              <th scope="col"><div align="right">Montant de paiement &nbsp; </div></th>
              <td><?php
    ...
    ?>
      &nbsp;&#x20B9;. <?php echo $billamt; ?></td>
            ...
            <tr>
              ...
              <td width="413">&nbsp;</td>
              <th width="442" scope="col"><div align="right">Taxe (5%) &nbsp; </div></th>
              <td width="413">&nbsp;&#x20B9;. <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
            </tr>

        <tr>
          <th scope="col"><div align="right">Raison de remise</div></th>
        ...
        <?php
          ...
          {
            echo "<strong>Pas de détails de transaction trouvés..</strong>";
          }
          else
          {
        ?>
