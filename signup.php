...
<h3 class="text-center txt-primary">Création de compte</h3>
</div>
</div>
<div class="row">
<div class="col-sm-6">
...
<span class="text-inverse">J'accepte les termes et conditions de l'application HealthCare !</span>
</label>
</div>
</div>
</div>
...
<div class="col-md-6">
<button type="submit" name="btn_check" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Créer mon compte maintenant</button>
</div>
<div class="col-md-6">
<p class="text-inverse text-right m-b-0">Merci.</p>
<p class="text-inverse text-right"><a href="login.php"><b class="f-w-600">Retourner vers l'authentification</b></a></p>
</div>
</div>
</div>
</div>
