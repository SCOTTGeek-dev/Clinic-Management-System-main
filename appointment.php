...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Pointage ajouté avec succés !</p>
                <p>
...
<li class="breadcrumb-item"><a>Pointage</a>
</li>
<li class="breadcrumb-item"><a href="appointment.php">Pointage</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            ...
            <option value="">Sélectionner Docteur</option>
            <?php
