    ...
    ?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Docteur supprimé avec succés ! </p>
            <p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>Es-tu sur de supprimer cet enregistrement ?</p>
    <p>
      <a href="view-doctor.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
...
<li class="breadcrumb-item"><a href="view_user.php">Docteur</a>
</li>
</ul>
</div>
</div>
